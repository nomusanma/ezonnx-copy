...
class DWPose(RTMPose):
    """DWPose ONNX model for whole body estimation.
    For person detection, RTMDet "m-person" model will be used by default.

    Args:
        identifier (str): Model identifier, e.g., "ll" is only available now.
    ...
    Examples:
        Usage example:
        ::
            from ezonnx import DWPose
            model = DWPose("ll")  # you can choose "ll"
