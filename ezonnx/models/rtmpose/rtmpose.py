...
class RTMPose(Inferencer):
    """RTMPose ONNX model for multi person pose estimation.
    For person detection, RTMDet "m-person" model will be used by default.

    Args:
        identifier (str): Model identifier, e.g., "s","m","l","x","m-hand","m-wholebody"
    ...
    Examples:
        Usage example:
        ::
            from ezonnx import RTMPose
            model = RTMPose("m")  # you can choose "s","m","l","x","m-hand","m-wholebody"
